...
#have decided that this does not make sense for our model. It shows exactly the same as the plots above, just like a barplot instead of a distribution...
```{r}
...
#IT IS POSSIBLE TO MAKE FOR RULEFOLLOWING, BUT I CANT FIGURE OUT IF IT MAKES SENSE RIGHT NOW
