...
ggarrange(plot_0.2.1 + rremove("x.text")+ rremove("xlab"), plot_0.4 + rremove("x.text")+ rremove("xlab")+ rremove("y.text") + rremove("ylab"), plot_0.6, plot_0.8 + rremove("y.text")+ rremove("ylab"),
          align = "hv",
          padding = 4,
          ncol = 2, nrow = 2)
